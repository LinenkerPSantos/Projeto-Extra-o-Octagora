"""
Extração: Formulário — NPS Especializado — Resultado
URL: /Edp/FlexForm/Report
Arquivo gerado: downloads/SP/nps_especializado{DDMMYYYY}.csv
...
# HTML: <option value="333355...">NPS - Especializado</option>
FORM_TOKEN = "333355774F66784D32633770454F6F52655461654A673D3D"


def run(regiao: str = "SP", date: str = None, date_start: str = None, date_end: str = None, log=print) -> Path | None:
    return extract_nps(
        form_token=FORM_TOKEN,
        output_prefix="nps_especializado",
        regiao=regiao,
        date=date,
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Extrai NPS Especializado")
