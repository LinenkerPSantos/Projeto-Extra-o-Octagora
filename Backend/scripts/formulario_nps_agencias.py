"""
Extração: Formulário — NPS Agências SP — Resultado
URL: /Edp/FlexForm/Report
Arquivo gerado: downloads/SP/nps_agencias{DDMMYYYY}.csv
...
# HTML: <option value="6D3047...">NPS - Agências SP</option>
FORM_TOKEN = "6D3047674E2F5750797072303769742B6F766A7137413D3D"


def run(regiao: str = "SP", date: str = None, date_start: str = None, date_end: str = None, log=print) -> Path | None:
    return extract_nps(
        form_token=FORM_TOKEN,
        output_prefix="nps_agencias",
        regiao=regiao,
        date=date,
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Extrai NPS Agências SP")
